...
def get_loader(args):
    if args.dataset == 'Aligned':
        data_path = '/data/zjw/MMER/data/train_valid_test.pt'
        ...
        data_path = '/data/zjw/MMER/data/train_valid_test_all_2.job'
    ...
    dev_loader = DataLoader(dev_set,
                            ...
                            num_workers=2,
                            pin_memory=False,
                            drop_last=True) if dev_set is not None else None
    test_loader = DataLoader(test_set,
                             sampler=test_sampler,
                             batch_size=args.eval_batch_size,
                             num_workers=2,
                             pin_memory=False,drop_last=True) if test_set is not None else None
